...
teamLead = TeamLead("Test", 100, 5, "Developer", "Python")
print(hasattr(teamLead, "name"))
print(hasattr(teamLead, "salary"))
print(hasattr(teamLead, "department"))
print(hasattr(teamLead, "programming_language"))
print(hasattr(teamLead, "team_size"))
