...
adwentures_of_tom_sawer = replace_dots(adwentures_of_tom_sawer)
...
adwentures_of_tom_sawer = clean_text(adwentures_of_tom_sawer)
print(adwentures_of_tom_sawer)
...
# task_09 = adwentures_of_tom_sawer.count("h")
# print(task_09)
...
print(count_letter(adwentures_of_tom_sawer, "h"))
...
def find_second(text, word):
    ...
    :return: second position of word in text
    """
...
print(find_second(adwentures_of_tom_sawer, "Tom"))
